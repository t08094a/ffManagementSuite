...
public class EmailResourceIntTest {
    ...
    private static final String DEFAULT_ADRESSE = "v@q6.kpdg";
    private static final String UPDATED_ADRESSE = "y8@j.dn";
    ...
    public void createEmail() throws Exception {
        ...
        assertThat(testEmail.getTyp()).isEqualTo(DEFAULT_TYP);
        assertThat(testEmail.getAdresse()).isEqualTo(DEFAULT_ADRESSE);
    }
    ...
    public void updateEmail() throws Exception {
        ...
        Email testEmail = emailList.get(emailList.size() - 1);
        assertThat(testEmail.getTyp()).isEqualTo(UPDATED_TYP);
        assertThat(testEmail.getAdresse()).isEqualTo(UPDATED_ADRESSE);
    }
