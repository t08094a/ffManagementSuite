...
import de.leif.ffmanagementsuite.domain.EntityAuditEvent;
...
public class JaversEntityAuditResource {
    ...
    public List<String> getAuditedEntities() {
      ...
      return Arrays.asList("AtemschutzInventar", "Ausbildung", "Auspraegung", "Berichtselement", "Dienststellung", "Dienstzeit", "DurchfuehrungPruefung", "DurchfuehrungWartung", "Email", "Erreichbarkeit", "Fahrzeug", "Fuehrerschein", "Inventar", "InventarKategorie", "Lehrgang", "Leistungspruefung", "Organisationsstruktur", "Person", "Pruefung", "Reinigung", "Schutzausruestung", "Verfuegbarkeit", "Wartung");
    }
    ...
    public ResponseEntity<List<EntityAuditEvent>> getChanges(@RequestParam(value = "entityType") String entityType,
        ...
        Class entityTypeToFetch = Class.forName("de.leif.ffmanagementsuite.domain." + entityType);
    ...
    public ResponseEntity<EntityAuditEvent> getPrevVersion(@RequestParam(value = "qualifiedName") String qualifiedName,
        ...
        Class entityTypeToFetch = Class.forName("de.leif.ffmanagementsuite.domain." + qualifiedName);
