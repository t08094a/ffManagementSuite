...
@Component({
    selector: 'jhi-person-ff',
    templateUrl: './person-ff.component.html'
})
export class PersonFfComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: PersonFf) {
        return item.id;
    }
